...
const StyledInputBase = styled(InputBase, {
  shouldForwardProp: prop => !['hasClearButton', 'expanded', 'expandable', 'textColor'].includes(prop as string)
})<StyledInputBaseProps>(({ theme, hasClearButton, expanded = true, expandable = false, textColor }) => ({
